...
with st.expander("See explanation"): 
    ...
    # Load File
    customers_df = pd.read_csv(r"C:\Users\Sidqi\OneDrive\Documents\submission\data\customers_dataset.csv")
...
def main():
    ...
    with st.expander("See explanation"):    
        ...
        ordersPayment_df = pd.read_csv(r"C:\Users\Sidqi\OneDrive\Documents\submission\data\order_payments_dataset.csv")
